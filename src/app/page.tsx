...
const Home = React.memo(function Home() {
  ...
  return (
    <div className="p-[6px] sm:p-[10px]">
      <Header onClick={() => { }} />

      <div className="h-[10px] sm:h-[20px]" />

      {/* hero img section */}
      <div id="Home" className="relative h-[75svh] max-h-[600px] min-h-[400px] w-full overflow-hidden rounded-[24px] sm:rounded-[36px] sm:h-[580px]">
        <div className="flex h-full flex-col items-start justify-end gap-2.5 bg-black/15 px-[16px] pb-6 backdrop-blur-[10px] sm:px-[40px] sm:pb-8">
          <div className="border-l-3 border-white pl-[16px] sm:pl-[20px] text-[15px] sm:text-normal2 text-white sm:font-bold">
            Voted #1 Pizza in Bergen County, NJ
          </div>
          <div className="text-[26px] sm:text-h2 leading-[1.2] font-semibold text-white sm:font-medium lg:text-h1" style={{ fontFamily: 'var(--font-creato-black)' }}>
            Signature Sourdough Pizza,
            <br />
            Subs, Burgers & More
            <br />
            <span className="text-[14px] sm:text-normal2 font-normal text-white/70" style={{ fontFamily: 'var(--font-creato)' }}>
          ...
          <MediaPreloader
            ...
            className="absolute top-0 left-0 -z-10 h-full w-full rounded-[24px] sm:rounded-[36px] object-cover sm:hidden"
          ...
          <MediaPreloader
            ...
            alt="Grumpy's Sourdough Pizza Co. - Best Pizza in Saddle Brook NJ"
            className="absolute top-0 left-0 -z-10 h-full w-full rounded-[36px] object-cover hidden sm:block"
            onLoaded={() => setHeroLoaded(true)}
          />
          ...
          {heroLoaded && (
            <>
              <div className="absolute top-0 left-0 -z-9 h-full w-full rounded-[24px] sm:rounded-[36px] bg-black/10 object-cover" />
              <div
                className="absolute top-0 left-0 -z-9 h-full w-full rounded-[24px] sm:rounded-[36px] object-cover"
                style={{
      ...
      <div id="Menu" className="w-full flex items-center justify-center text-center flex-col">
        <div className="text-[28px] sm:text-h3 md:text-h2 w-full">
        ...
        <div className="text-normal text-[14px] sm:text-normal3 mt-[16px] sm:mt-[20px] max-w-[620px] mx-auto px-[10px] sm:px-0" style={{ color: 'var(--tt-color-text-gray)' }}>
